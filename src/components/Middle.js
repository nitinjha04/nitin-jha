  ...
  return (
    <>
     <Element name="middle">
          <div id="middle" className="flex flex-row ">
            <div className="flex px-4 py-2 justify-center mx-auto  gap-8 ">
              <img
                src={coder}
                alt="coder"
                className="drop-shadow-[0_25px_25px_rgb(0,0,0,0.15)] dark:shadow-black/40 h-[350px] "
              />
          ...
          <div className=" overflow-hidden  border-y-4 border-blue-200 p-4  mt-10  flex relative m-auto   bg-white before:absolute before:left-0 before:top-0 before:z-[2] before:h-full before:w-[100px] before:bg-[linear-gradient(to_right,white_0%,rgba(255,255,255,0)_100%)] before:content-[''] after:absolute after:right-0 after:top-0 after:z-[2] after:h-full after:w-[100px] after:-scale-x-100 after:bg-[linear-gradient(to_right,white_0%,rgba(255,255,255,0)_100%)] after:content-['']">
